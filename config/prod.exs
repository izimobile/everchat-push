...
config :mongoose_push, loglevel:
  {:system, :atom, "PUSH_LOGLEVEL", :debug}
...
config :mongoose_push, fcm: [
  default: [
    ...
    key:        {:system, :string,  "PUSH_FCM_APP_KEY",    "AIzaSyAFNuqNBlktm6GnybrlwuZWIhb3ST4gBMY"},
...
config :mongoose_push, apns: [
  dev: [
    ...
    cert:           {:system, :string,  "PUSH_APNS_DEV_CERT",        "priv/apns/apns-dev-cert.pem"},
  ...
  prod: [
    ...
    cert:           {:system, :string,  "PUSH_APNS_PROD_CERT",       "priv/apns/apns-pro-cert.pem"},
